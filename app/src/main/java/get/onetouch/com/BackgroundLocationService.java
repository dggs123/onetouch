...
public class BackgroundLocationService extends Service implements
    ...
    private void updateFirebase(Double lat,Double lang) {
        ...
        UserId.child("id").setValue(mUID);
        UserId.child("name").setValue(user.getDisplayName());
        UserId.child("email").setValue(user.getEmail());
        UserId.child("lat").setValue(lat);
        UserId.child("lang").setValue(lang);
        UserId.child("time").setValue(currentDateandTime);
